...
def generate_plots(N, mu, sigma2, S):
    # STEP 1: Generate dataset and fit initial linear regression

    # Generate random dataset X with values between 0 and 1
    X = np.random.rand(N)
    ...
    for _ in range(S):
        # Generate new random X and Y datasets for each simulation
